...
class DetailsTimeLinePage extends StatefulWidget {
  ...
  @override
  State<DetailsTimeLinePage> createState() =>
      _DetailsTimeLinePageState(id: id, isUser: isUser);
}

class _DetailsTimeLinePageState extends State<DetailsTimeLinePage> {
  var id;
  var isUser;
  _DetailsTimeLinePageState({required this.id, required this.isUser});
  ...
  void initState() {
    ...
    String collection = isUser ? 'Users' : 'Companies';
      ...
      body: dates.isEmpty
          ? Container(
              ...
              child: const Column(
                ...
                children: [
                  Text(
                    "Cette entreprise n'a pas encore publiée de dates clés.",
