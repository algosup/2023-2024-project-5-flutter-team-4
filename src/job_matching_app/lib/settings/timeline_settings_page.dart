...
class TimelineSettingsPage extends StatefulWidget {
  ...
  State<TimelineSettingsPage> createState() =>
      _TimelineSettingsPageState(id: id, isUser : isUser);
}

class _TimelineSettingsPageState extends State<TimelineSettingsPage> {
  var id;
  var isUser;
  _TimelineSettingsPageState({required this.id, required this.isUser});
  ...
  void initState() {
    ...
    collection = isUser ? 'Users' : 'Companies';
                                                                  ...
                                                                  children: <Widget>[
                                                                    Padding(
                                                                      ...
                                                                      child:
                                                                          TextFormField(
                                                                        controller:
                                                                            TextEditingController(text: dates[i]),
                                                                        decoration:
                                                                    ...
                                                                    Padding(
                                                                      ...
                                                                      child:
                                                                          TextFormField(
                                                                        controller:
                                                                            TextEditingController(text: datesDescription[i]),
                                                                        onChanged:
                                                                            (value) =>
                                                                                {
                                                                          dateDescriptionTemp =
